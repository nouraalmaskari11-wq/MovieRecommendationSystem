...
namespace MovieRecommendationSystem.Console.UI
{
    public static class ConsoleHelper
    {
        ...
        public static void PrintMovies(List<Models.Movie> movies, string title = "📽️ MOVIE LIST")
        {
            PrintHeader(title);
        ...
        public static void ShowMainMenu()
        {
            ...
            System.Console.WriteLine("   1️⃣  Register");
            System.Console.WriteLine("   2️⃣  Login");
            System.Console.WriteLine("   3️⃣  Exit");
            System.Console.WriteLine();
        }
        ...
        public static void ShowSearchMenu()
        {
            ...
            System.Console.WriteLine("   1️⃣  Search by Title");
            System.Console.WriteLine("   2️⃣  Search by Genre");
            System.Console.WriteLine("   3️⃣  Search by Year");
            System.Console.WriteLine("   4️⃣  Search by Director");
            System.Console.WriteLine("   5️⃣  Search by Rating (min 1-5)");
            System.Console.WriteLine("   6️⃣  Back to Dashboard");
            System.Console.WriteLine();
        }
    }
}